    ...
    <div v-else class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
        <div class="mdl-card mdl-shadow--2dp employer-form">
            <div class="mdl-card__title">
                <h5 class="mdl-card__title-text text-color--white">Редактирование поста - {{ inputs.title }}</h5>
            </div>
...
export default {
    ...
    async beforeMount() {
        await this.$store.dispatch('loadSingle', {
            name: 'post',
            type: 'posts',
        ...
        this.inputs.description = this.post.description;
    },
}
</script>
