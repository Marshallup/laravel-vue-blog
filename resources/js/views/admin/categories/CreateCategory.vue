<template>
    <div class="mdl-card mdl-shadow--2dp employer-form">
        <div class="mdl-card__title">
            <h5 class="mdl-card__title-text text-color--white">Создание категории</h5>
        </div>
...
export default {
    ...
    methods: {
        async createTag () {
            ...
            const response = await this.$store.dispatch('admin/createTagCategory', { path: 'categories', inputs })
            this.title = '';
            if (response.errors) {
